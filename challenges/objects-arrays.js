...
zooAnimals.forEach(value => animalNames.push(`Animal Name: ${value.animal_name}, Scientific Name: ${value.scientific_name}`))
...
const largerPopulation = [zooAnimals.filter( isSmall => isSmall.population < 5)];
...
zooAnimals.forEach((animal)=>{
  array.push(animal.population);
})
const reducer = (accumulator, currentValue) => accumulator + currentValue
const populationTotal = array.reduce(reducer);
